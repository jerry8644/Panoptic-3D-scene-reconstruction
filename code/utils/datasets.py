...
from utils.general import check_requirements, coco2yolo, xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, \
            ...
            try:
                ...
                if os.path.isfile(lb_file):
                    ...
                    with open(lb_file, 'r') as f:
                        ...
                        l[:, 1:5] = coco2yolo(l[:, 1:5], w=shape[0], h=shape[1])
                    if len(l):
